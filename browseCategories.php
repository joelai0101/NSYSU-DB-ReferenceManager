...
// Fetch only public categories from the database
$categories = [];
$query = "SELECT CategoryID, CategoryName, CategoryDescription FROM Categories WHERE IsPublic = 1";
